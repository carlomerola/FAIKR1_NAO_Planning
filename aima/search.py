...
class PlanRoute(Problem):
    ...
    def __init__(self, initial, goal, allowed, dimrow):
        """ Define goal state and initialize a problem """
        super(PlanRoute,self).__init__(initial, goal)
        self.dimrow = dimrow
        self.goal = goal
...
class PeakFindingProblem(Problem):
    ...
    def __init__(self, initial, grid, defined_actions=directions4):
        ...
        super(PeakFindingProblem,self).__init__(initial)
        self.grid = grid
...
class OnlineSearchProblem(Problem):
    ...
    def __init__(self, initial, goal, graph):
        super(OnlineSearchProblem,self).__init__(initial, goal)
        self.graph = graph
...
class GraphProblem(Problem):
    ...
    def __init__(self, initial, goal, graph):
        super(GraphProblem,self).__init__(initial, goal)
        self.graph = graph
...
class NQueensProblem(Problem):
    ...
    def __init__(self, N):
        super(NQueensProblem,self).__init__(tuple([-1] * N))
        self.N = N
